...
CREATE TABLE EMPLOYEE(
    ...
    CONSTRAINT FK_EMPLOYEE_DEPARTMENT FOREIGN KEY(DEPT_NO) REFERENCES DEPARTMENT(DEPT_NO) ON DELETE SET NULL  -- 부서가 없어지면 사원의 부서 정보만 NULL 처리 된다.
);
...
CREATE TABLE PROCEEDING(
    ...
    CONSTRAINT FK_PROCEEDING_EMPLOYEE FOREIGN KEY(EMP_NO) REFERENCES EMPLOYEE(EMP_NO) ON DELETE CASCADE,
    CONSTRAINT FK_PROCEEDING_PROJECT FOREIGN KEY(PJT_NO) REFERENCES PROJECT(PJT_NO) ON DELETE CASCADE
);