...
-- 프로시저4 정의(만들기) : 사원번호를 100인 사원의 FIRST_NAME, LAST_NAME을 출력 파라미터로 반환하는 프로시저
-- 출력 파라미터
...
-- PORC5(0, FNAME)   : 사원번호 0은 Noname입니다.
...
-- BUY_PROC 프로시저 정의
CREATE OR REPLACE PROCEDURE BUY_PROD
(
...
EXECUTE BUY_PROD(1, 1000, 10);  -- 고객번호 1, 제품코드 1000, 구매수량 10

BEGIN
    BUY_PROD(2, 1001, 5);  -- 고객번호 2, 제품코드 1001, 구매수량 5
END;